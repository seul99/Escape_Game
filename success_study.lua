...
function scene:create( event )
	...
	-- BACKGROUND
	local bg = display.newImage("Image/study/study_puzzle_completed_no_eyes.png")
	...
	-- 미니게임 서재 책 맞추기 게임 성공
	local Data = jsonParse("json/diag_success_study.json")
	if(Data) then
	...
	local function nextScript( event )
        ...
        ------ 눈 뜬 부분이랑 눈 없는 부분이랑 사진 크기가 달라서 좀 이상하게 나와요! 크기 비슷하게 맞추는거 필요할 듯 싶슴다~
		bg.fill = {
			type = "image",
